...
<div align="center" >
<form className="form" onSubmit={handleSubmit} style={{"padding":3,"width":700,"padding":30,fontFamily:'sans-serif',color:'black'}} >
...
<div className="log">
<label>Category Rep id</label><input type="number" id="userid" className="form-control" onChange={(e)=>setUser({...user,userid:e.target.value}) }
 required /><br/>
